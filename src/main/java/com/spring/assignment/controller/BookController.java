...
import com.spring.assignment.domain.book.service.BookService;
import com.spring.assignment.domain.publisher.service.PublisherService;
...
public class BookController {
    ...
    public ResponseEntity<List<BookDTO.Response>> getBookByPublisherId(@PathVariable Long publisherId) {
        List<BookDTO.Response> books = publisherService.getAllBookByPublisherId(publisherId);
        return ResponseEntity.ok(books);
    }
